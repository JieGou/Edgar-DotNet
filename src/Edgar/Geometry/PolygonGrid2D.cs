...
namespace Edgar.Geometry
{
    ...
    /// <list type="bullet">
    /// <item><description><em>a polygon has at least 4 points</em></description></item>
    /// <item><description><em>all lines must be parallel to one of the axis</em></description></item>
    /// <item><description><em>no two adjacent line can be both horizontal or both vertical</em></description></item>
    /// <item><description><em>points are in a clockwise order</em></description></item>
    /// </list>
    /// </remarks>
